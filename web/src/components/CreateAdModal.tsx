...
export function CreateAdModal() {
    ...
    async function handleCreateAd(event: FormEvent) {
        ...
        console.log(`yearsPlaying: ${Number(data.yearsPlaying)}`);
        console.log(`discord: ${data.discord}`);
        console.log(`weekDays: ${weekDays.map(Number)}`);
        console.log(`hourStart: ${data.hourStart}`);
        console.log(`hourEnd: ${data.hourEnd}`);
        console.log(`useVoiceChat: ${useVoiceChannel}`);
        try {
